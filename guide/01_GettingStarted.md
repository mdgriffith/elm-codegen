...
- [Installing package helpers](UsingPackages), which we'll cover a little later.
...
You should be good to proceed to the [Writing a Generator]() section, but before you go, let's quickly cover some other useful options in the `elm-codegen` CLI.
