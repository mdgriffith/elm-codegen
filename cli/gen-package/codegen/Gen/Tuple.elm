module Gen.Tuple exposing (first, mapBoth, mapFirst, mapSecond, moduleName_, pair, second, types_, values_)

{-| 
@docs moduleName_, pair, first, second, mapFirst, mapSecond, mapBoth, types_, values_
-}
