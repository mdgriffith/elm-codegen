module Gen.Dict exposing (diff, empty, filter, foldl, foldr, fromList, get, insert, intersect, isEmpty, keys, map, member, merge, moduleName_, partition, remove, singleton, size, toList, types_, union, update, values, values_)

{-| 
@docs moduleName_, empty, singleton, insert, update, remove, isEmpty, member, get, size, keys, values, toList, fromList, map, foldl, foldr, filter, partition, union, intersect, diff, merge, types_, values_
-}
...
filter arg1 arg2 =
    Elm.apply
        ...
        [ Elm.functionAdvanced
            [ ( "ar0", Type.var "comparable" ), ( "ar1", Type.var "v" ) ]
            (arg1
                (Elm.valueWith
                    { importFrom = []
                    , name = "ar0"
