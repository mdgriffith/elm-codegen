module Elm.Case exposing
    ...
    , tuple, triple
    , patternToBranch, patternToBranch2
    , custom
...
@docs patternToBranch, patternToBranch2
...
{-| -}
patternToBranch2 : (a -> Expression) -> Pattern a -> Branch
patternToBranch2 branchBody (Pattern pattern destructure) =
    Branch
        (\index ->
            ( Index.startIndex
            , pattern
